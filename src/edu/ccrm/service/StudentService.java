...
public class StudentService {
    ...
    public void addStudent(Student student, Connection conn) throws DataIntegrityException {
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
            ...
            pstmt.setString(7, student.getRegistrationDate().toString());
            pstmt.executeUpdate();
        } catch (SQLException e) {
    ...
    public Student mapRowToStudent(ResultSet rs) throws SQLException {
        ...
        // SQLite uses text for dates, handle nulls and weird formats gracefully
        String dateStr = rs.getString("registration_date");
        LocalDate registrationDate = LocalDate.now(); // Fallback
        ...
        if (dateStr != null && !dateStr.trim().isEmpty()) {
            try {
                ...
                registrationDate = LocalDate.parse(dateStr);
            } catch (Exception e) {
